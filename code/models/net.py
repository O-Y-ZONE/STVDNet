...
class CoarseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x_block0, x_block1, x_block2, x_block3, x_block4, x_block5 = self.E(x)
        x_decoder = self.D(x_block0, x_block1, x_block2, x_block3, x_block4, x_block5)
        x_mff = self.MFF(x_block1, x_block2, x_block3, x_block4, x_block5, [x_decoder.size(2),x_decoder.size(3)])
